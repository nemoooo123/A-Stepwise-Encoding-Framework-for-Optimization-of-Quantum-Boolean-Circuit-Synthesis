...
def DE_run_single_experiment(
    ...
    while current_iter < max_iterations:
        ...
        nbr1,nbr2,nbr3,nbr4,new_fit, circuit_solutions = Differential_Evolution(nbr1, nbr2, nbr3, nbr4,
                                                   ...
                                                   [m[0] for m in sorted_metrics], [m[1] for m in sorted_metrics],[m[2] for m in sorted_metrics], base_trajectory, circuit_solutions)
...
def Differential_Evolution(nbr1, nbr2, nbr3, nbr4, num_neighbors, num_bits, CR,
                           encoding_table, path_table, local_best_gate_count,local_no_repeat_best_gate_count, local_best_idx, trajectories, circuit_solutions):
    """
...
def mutation(nbr1, nbr2, nbr3, nbr4, num_bits, num_neighbors, index, CR,
    ...
    if trial_fitness <= target_fitness_2:
        return trial_n1,trial_n2,trial_n3,trial_n4,[trial_fitness, gate_set], [synthesized_circuit, trial_fitness, gate_set]
